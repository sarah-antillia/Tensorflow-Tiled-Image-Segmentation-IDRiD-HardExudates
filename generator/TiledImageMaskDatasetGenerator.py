...
class TiledImageMaskDatasetGenerator:
  ...
  def create_mask_files(self, mask_file, index):
    ...
    resized = self.resize_to_square(mask)
  ...
  def create_image_files(self, image_file, index):
    ...
    # Create 512x512 resized.
    #resized = self.resize_to_square(mask)
    resized = self.resize_to_square(image)    
  ...
  def generate(self, input_images_dir, input_masks_dir, 
    ...
    mask_files = glob.glob(input_masks_dir + "/*.tif")
...
if __name__ == "__main__":
  try:
    input_images_dir = "./1. Original Images/a. Training Set/"
    input_masks_dir  = "./2. All Segmentation Groundtruths/a. Training Set/3. Hard Exudates/"

    output_images_dir = "./Tiled-IDRiD-master/images/"
    output_masks_dir  = "./Tiled-IDRiD-master/masks/"
