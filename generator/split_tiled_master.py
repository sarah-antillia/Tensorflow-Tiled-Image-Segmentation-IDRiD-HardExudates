...
if __name__ == "__main__":
  try:
    images_dir = "./Tiled-IDRiD-master/images/"
    masks_dir  = "./Tiled-IDRiD-master/masks/"
    output_dir = "./Tiled-IDRiD-HardExudates-ImageMask-Dataset/"
